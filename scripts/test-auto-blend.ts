...
assertEqual('preset: normal burst settle', normal.burstSettleMs, 1500)
assertEqual('preset: normal rate limit window', normal.rateLimitWindowMin, 10)
assertEqual('preset: normal rate limit stop threshold', normal.rateLimitStopThreshold, 3)
