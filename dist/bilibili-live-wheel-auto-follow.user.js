  ...
  function bindEvents(roomId, live) {
    ...
    live.addEventListener("POPULARITY_RED_POCKET_START", ({ data }) => {
      ...
      emit({
        ...
        source: "ws",
        badges: ["红包"],
        avatarUrl: avatarUrl$1(String(d2.sender_uid ?? d2.uid ?? "")),
        rawCmd: data.cmd
      });
    });
...
🔵 本地测试完成！共测试 ${total} 个词，其中 ${totalBlocked} 个原词被屏蔽`);
    ...
    return u$2(S$1, { children: [
u$2("details", { className: "cb-settings-accordion", open: true, children: [
  ...
  function UserNotice() {
    ...
    return u$2(
      "div",
      {
        ...
        children: [
u$2("div", { style: { color: toneColor, fontWeight: 650, marginBottom: "2px" }, children: notice.tone === "error" ? "操作失败" : "需要注意" }),
